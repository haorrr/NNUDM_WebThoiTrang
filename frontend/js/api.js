...
function normalizeProduct(p) {
  ...
  return {
    ...
    flashStockLimit: p.flashStockLimit != null ? toNumber(p.flashStockLimit, 0) : toNumber(p.flash_stock_limit, null),
    flashSoldCount: p.flashSoldCount != null ? toNumber(p.flashSoldCount, 0) : toNumber(p.flash_sold_count, null),
    flashRemaining: p.flashRemaining != null ? toNumber(p.flashRemaining, 0) : toNumber(p.flash_remaining, null),
